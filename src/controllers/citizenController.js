let complaintList = [];
import { classifyComplaint } from "../../python-services/api/classifier_model.js";
...
export async function myComplaints(req, res) {
  const aiResult = await classifyComplaint(complaintList[complaintList.length - 1].complaint);
